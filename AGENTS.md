...
|-------------------|--------------|
| Zweck, Zielgruppen, Nutzungsszenarien oder fachliche Anforderungen | Im aktuellen Seitenbranch `Project/2do/FACHKONZEPT-ENTWURF.txt`; nach Main-Uebernahme `Project/FACHKONZEPT.txt` |
